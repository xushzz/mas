...
import com.sirap.geek.GeekManager;
...
//		C.list(DevManager.g().allCodingNames());
		C.list(GeekManager.g().searchCodingNames("big5|gbk"));
	}
	public void is2by() throws Exception {
		String source = "\\uCDF2ACD\\uCDF2";
		String va = CodeUtil.replaceHexChars(source, Konstants.CODE_GBK);
		C.pl(va);

		source = "\\uE4B887THINK\\uE4B887";
		va = CodeUtil.replaceHexChars(source, Konstants.CODE_UTF8);
		C.pl(va);

		source = "\\u4E07LEILA\\u4E07";
		va = CodeUtil.replaceHexChars(source, Konstants.CODE_UNICODE);
		C.pl(va);
	}
...
//		C.pl(DevManager.decode("E6ACA1", "UTF-8"));
		C.pl(CodeUtil.decodeHexChars("A1A2", "GBK"));
		C.pl(CodeUtil.decodeHexChars("3023", "Unicode"));
		C.pl(CodeUtil.decodeHexChars("E38081", "UTF-8"));
	}
	...
	public void bytes2Hex() {
		...
		String v2 = CodeUtil.encode2HexChars('万', Konstants.CODE_UTF8);
		String v3 = CodeUtil.encode2HexChars('万', Konstants.CODE_GBK);
		String v4 = CodeUtil.encode2HexChars('万', Konstants.CODE_UNICODE);
		C.pl(v1);
		C.pl(v2);
		C.pl(v3);
		C.pl(v4);
	...
	public void encode() {
		CodeUtil.encode2HexChars('万', Konstants.CODE_UTF8);
		CodeUtil.encode2HexChars('万', Konstants.CODE_GBK);
		CodeUtil.encode2HexChars('万', Konstants.CODE_UNICODE);
		C.pl();
		CodeUtil.encode2HexChars('T', Konstants.CODE_UTF8);
		CodeUtil.encode2HexChars('T', Konstants.CODE_GBK);
		CodeUtil.encode2HexChars('T', Konstants.CODE_UNICODE);
		C.pl();
		CodeUtil.encode2HexChars('の', Konstants.CODE_UTF8);
		CodeUtil.encode2HexChars('の', Konstants.CODE_GBK);
		CodeUtil.encode2HexChars('の', Konstants.CODE_UNICODE);
	...
	public void base64() throws Exception {
		...
		String v1 = "T法の";
		String t64 = CodeUtil.toBase64(v1);
		String f64 = CodeUtil.fromBase64(t64);
		D.pl(v1, t64, f64);
	}
}

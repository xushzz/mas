...
public class TextSearcher {
	...
	private List<MexObject> allItems;
	...
	public static List<MexObject> search(String foldersStr, String fileNameCriteria, String criteria, String charset) {
		List<String> folders = StrUtil.splitByRegex(foldersStr);
		return search(folders, fileNameCriteria, criteria, charset);
	}
	
	public static List<MexObject> search(List<String> folders, String fileNameCriteria, String criteria) {
		return search(folders, fileNameCriteria, criteria, null);
	}
	
	public static List<MexObject> search(List<String> folders, String fileNameCriteria, String criteria, String charset) {
